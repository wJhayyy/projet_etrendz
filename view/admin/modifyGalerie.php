...
if (isset($_POST['id_galerieimg'])) {
    $id_galerieimg = $_POST['id_galerieimg'];
    ...
    try {
        ...
        $stmt_galerie->bindParam(':id_galerieimg', $id_galerieimg, PDO::PARAM_INT);
    ...
    echo "Aucun ID de la galerie reçu via POST.";
}
                ...
                <div class="space-y-1 text-center">
                  ...
                  <div class="flex text-sm text-gray-600">
                    <label for="img_photo" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      ...
                      <input id="img_photo" name="img_photo" type="file" class="sr-only" onchange="updateBackgroundImage('image_galerie_div', event)">
                    </label>
                  </div>
