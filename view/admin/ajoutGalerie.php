...
<section class="max-w-4xl p-6 mx-auto bg-color2 rounded-md shadow-md dark:bg-gray-800 mt-24">
    <h2 class="text-xl font-bold text-white capitalize dark:text-white">Ajout d'une image de galerie</h2>
    <form method="POST" action="index.php?admin=addGalerie" enctype="multipart/form-data">
